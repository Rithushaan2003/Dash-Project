...
sudo tc class add dev enp0s3 parent 1: classid 1:1 htb rate 10mbit 

sudo tc class add dev enp0s3 parent 1:1 classid 1:10 htb rate 2mbit prio 0 

sudo tc class add dev enp0s3 parent 1:1 classid 1:12 htb rate 1mbit prio 1 

sudo tc filter add dev enp0s3 protocol ip parent 1:0 prio 1 u32 match ip dport 5201 0xffff flowid 1:10
